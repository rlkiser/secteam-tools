...
#This is a script to test Koji build (for OSG3.4) in Scientific Linux 7.
...
rpm -Uvh http://repo.opensciencegrid.org/osg/3.4/osg-3.4-el7-release-latest.rpm
...
rpm -q osg-release-3.4-*.osg34.el7.noarch
echo 
