...
#This is a script to test Koji build (for OSG3.3) in Scientific Linux 6.
...
echo "----------------------------------------" >> testresult
echo "----------------------------------------" >> testresult
echo " Test results of test-script-SL6-OSG3.3 " >> testresult
echo "----------------------------------------" >> testresult
echo "----------------------------------------" >> testresult
echo >> testresult
...
rpm -ivh http://repo.opensciencegrid.org/osg/3.3/osg-3.3-el6-release-latest.rpm
echo 

#Check an installed RPM Package
echo "Installed package is:"
rpm -q osg-release-3.3-*.osg33.el6.noarch
echo 

#Upgrade a RPM Package
rpm -Uvh http://repo.opensciencegrid.org/osg/3.3/osg-3.3-el6-release-latest.rpm
