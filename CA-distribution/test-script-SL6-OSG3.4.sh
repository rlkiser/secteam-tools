...
#This is a script to test Koji build (for OSG3.4) in Scientific Linux 6.
...
echo "----------------------------------------" >> testresult
echo "----------------------------------------" >> testresult
echo " Test results of test-script-SL6-OSG3.4 " >> testresult
echo "----------------------------------------" >> testresult
echo "----------------------------------------" >> testresult
echo >> testresult
...
rpm -q osg-release-3.4-*.osg34.el6.noarch
echo 
